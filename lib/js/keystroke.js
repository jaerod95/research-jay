var jr_key = {
    ...
    p1: `<div class="jr_content_page"><h1>FILLER PAGE 1</h1><button onclick="jr_key.randomlyLoadPage()">Next</button></div>`,
    p2: `<div class="jr_content_page"><h1>FILLER PAGE 2</h1><button onclick="jr_key.randomlyLoadPage()">Next</button></div>`,
    p3: `<div class="jr_content_page"><h1>FILLER PAGE 3</h1><button onclick="jr_key.randomlyLoadPage()">Next</button></div>`,
    p4: `<div class="jr_content_page"><h1>FILLER PAGE 4</h1><button onclick="jr_key.randomlyLoadPage()">Next</button></div>`,
    p5: `<div class="jr_content_page"><h1>FILLER PAGE 5</h1><button onclick="jr_key.randomlyLoadPage()">Next</button></div>`,
    p6: `<div class="jr_content_page"><h1>FINISH PAGE</h1></div>`,
}
